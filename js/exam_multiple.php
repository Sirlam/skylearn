...
<div id="survey_container">
	...
	<form name="example-1" id="wrapped" action="" method="POST">
		<div id="middle-wizard">
			...
			<div class="step row">
				<div class="row">
					<h3 class="col-md-12">What is the name of the first second president of Nigeria ?</h3>
            ...
            <div class="step row">
				<div class="row">
					<h3 class="col-md-12">What is the name of the third second president of Nigeria ?</h3>
			...
			<div class="submit step" id="complete">
						...
						<button type="submit" name="process" class="submit">Submit Test</button>
			</div><!-- end submit step -->
...
<div class="col-md-12">
	...
	<div id="container">
			...
			<script type="text/javascript" charset="utf-8">
         	...
         	fontColor   : '#FFFFFF',
         	autostart   : false,
         	onComplete  : function () { alert('I am going to submit the form now') }
		   });
			countdown.start();
