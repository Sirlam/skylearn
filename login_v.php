                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                <li><a href="index.php" class="external-link" target="_parent">HOME</a></li>
                                ...
                                <li class="active"><a href="register.php" class="external-link" target="_parent">REGISTER</a></li>
								<li class="dropdown">
                ...
                <div id="templatemo-contact">
                    <div class="container">
                        <div class="row">
                            ...
                            <!-- Registration form -->
                            <form action="login_init.php" method="post"><!--TO reg_auth.php-->
                                <div class="row">
                                        ...
                                        <div class="panel registration-form">
                                            <div class="panel-body">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <button type="submit" class="btn bg-teal-400 btn-labeled btn-labeled-right ml-10"><b><i class="icon-key"></i></b> Login</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
