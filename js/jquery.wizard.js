(function(e, t) {
	var n, r = 0, i = {}, s = {}, o = Array.prototype.slice, u = function(t) {
		return e.isArray(t) ? t : [t]
	}, a = "id", f = "form", l = "click", c = "submit", h = "disabled", p = "wizard", d = "default", v = "number", m = "object", g = "string", y = "boolean", b = "afterBackward", w = "afterDestroy", E = "afterForward", S = "afterSelect", x = "beforeBackward", T = "beforeDestroy", N = "beforeForward", C = "beforeSelect", k = "beforeSubmit";
	...
	e.widget("kf." + p, {
		...
		_create : function() {
			var t, n, o = this, l = o.options, c = o.element, h = c.find(l.steps), v = h.eq(0).parent();
			if (c[0].elements) {
				t = c
		...
		_fastForward : function(n, r, i) {
			var s = 0, o = this, u = o._currentState.stepIndex, a = [u];
			if (e.isFunction(r)) {
				i = r;
				r = t
			}
		...
		_find : function(t, n, r) {
			...
			var i, s, o, a, f, l = [], c = n instanceof jQuery ? n : e(n);
			if (t !== null && c.length) {
				t = u(t);
		...
		_state : function(t, n) {
			...
			var r = this.options, s = e.extend(true, {}, this._currentState);
			n = u(n || t);
		...
		_transition : function(n, r, i) {
			...
			var a, f = s.options, l = s.step(n, r), c = l.attr(f.stateAttribute), h = c ? f.transitions[c] : f.transitions[d];
			if (e.isFunction(h)) {
		...
		_update : function(t, n) {
			var r = this._currentState, i = this.options;
			if (r.step) {
