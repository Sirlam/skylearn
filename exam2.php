...
<?php
	...
	$query = mysql_query("SELECT * FROM `subjects` WHERE `cat`='$catt' AND `title`='$titlee' ");
	$row = mysql_fetch_assoc($query);
	$questionpath = $row['path'];
...
function translateToGrade($percentage) {
	...
	<form name="example-1" id="wrapped" action="" method="POST">
		<div id="middle-wizard">
			<div class="step">
				<div class="row">
					<h1 class="col-md-12">GOOD LUCK</h1>
					
					
							
								<br/><h4 style="text-align:center">Click Next To Continue</h4>
	...
	$loadedQuestions = readQuestions($questionpath);
