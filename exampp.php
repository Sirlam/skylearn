...
function translateToGrade($percentage) {
	...
	<form name="example-1" id="wrapped" action="" method="POST">
		<div id="middle-wizard">
			<div class="step">
				<div class="row">
					<h3 class="col-md-12">What is the name of your country?</h3>
					
					<ul>
						
						<li>
							
								<input type="checkbox"/><h4>A) Nigeria</h4>
						</li>
						
						<li>
							
								<input type="checkbox"/><h4>B) Ghana</h4>
						</li>
						<li>
							
								<input type="checkbox"/><h4>C) Zambia</h4>
						</li>
						<li>
